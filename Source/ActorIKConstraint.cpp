...
ActorIKConstraint::InfluencedBone::InfluencedBone() : boneIndex(0), bone(nullptr)
{
...
ActorIKConstraint* ActorIKConstraint::read(Actor* actor, BlockReader* reader, ActorIKConstraint* ik)
{
    if(ik == nullptr)
    {
    ...
    if(numInfluencedBones > 0)
    {
        ...
        {
            influenced.boneIndex = reader->readUnsignedShort();
        }
    }
    return ik;
}
